...
if(sum ){
  number1 = 10;
  number2 = 12;
  console.log(showOperationMessage(operationsSignal, number1, number2), sum ( number1, number2));
}
  else {
  console.log (showErrorMessagem(operationsSignal))};
/*
...
if(sum ){
  number1 = 8;
  number2 = 11;
  console.log(showOperationMessage(operationsSignal, number1, number2), subtration ( number1, number2));
}
  else {
  console.log (showErrorMessagem(operationsSignal))};
/*
